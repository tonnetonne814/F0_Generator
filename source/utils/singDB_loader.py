...
def get_annotated_data(ust_path, lab_path, ono2lab_table_path):
    ...
    word_lines = list()
    for idx, line in enumerate(data_UST):
        text = line["lyric"]
        ...
        word_line = {"word": text, 
                     "ph": ph_list ,
                     "word_start_ms":start_point, 
                     "word_end_ms": end_point, 
                     "word_dur_ms": end_point-start_point,
                     "note_num": note_num,
                     "notename": notename,
                     "note_start_ms" : note_start_ms,
                     "note_end_ms" : note_end_ms,
                     "note_dur_ms": note_dur}
